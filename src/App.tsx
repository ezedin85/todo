...
console.log("this is branch 3")
    ...
    return (
        <div className='flex justify-between p-3 border bg-gray-50'>
            ...
            <ListSection todos={todos} filter={filter} setTodos={setTodos} setAction={setAction} setActiveSection={setActiveSection} activeTask={activeTask} setActiveTask={setActiveTask}/>
            <FormSection todos={todos} setTodos={setTodos} action={action} setAction={setAction} activeSection={activeSection} setActiveSection={setActiveSection} setActiveTask={setActiveTask}/>
        </div>
    )
}
